...
$('document').ready(function () {
    ...
    var DisplayPane = (function () {
        ...
        DisplayPane.prototype.lineformat = function () {
            ...
            ajax("resources/lineformatter/" + this.db + "/" + agencyid + "/" + bibliographicrecordid.replace(/\s/g, '%20'),
        ...
        DisplayPane.prototype.versionSelected = function (event, ui) {
            ...
            if (thisVersion === '-1') {
                ...
                ajax("resources/record-merged/" + this.db + "/" + agencyid + "/" + bibliographicrecordid.replace(/\s/g, '%20'),
                    this.displayRecord.bind(this));
            } else {
                this.otherVersionSelect.selectmenu('enable');
                if (otherVersion === '') {
                    ajax("resources/record-historic/" + this.db + "/" + agencyid + "/" + bibliographicrecordid.replace(/\s/g, '%20') + "/" + thisVersion,
                        this.displayRecord.bind(this));
                } else {
                    ajax("resources/record-diff/" + this.db + "/" + agencyid + "/" + bibliographicrecordid.replace(/\s/g, '%20') + "/" + thisVersion + "/" + otherVersion,
                        this.displayRecord.bind(this));
                }
            }
        };
        ...
        DisplayPane.prototype.setId = function (val) {
            if (this.idInput.val() !== val) {
                ...
                var bibliographicrecordid = arg[2];
                this.clear();
                ajax("resources/record-history/" + this.db + "/" + agencyid + "/" + bibliographicrecordid.replace(/\s/g, '%20'),
                    this.historyRead.bind(this));
                ajax("resources/relations/" + this.db + "/" + agencyid + "/" + bibliographicrecordid.replace(/\s/g, '%20'),
    ...
    var PageOptions = (function () {
        ...
        PageOptions.prototype.bibliographicRecordIdChanged = function () {
            ...
            if (bibliographicrecordid !== '') {
                ajax("resources/agencies-with/" + this.db + "/" + bibliographicrecordid.replace(/\s/g, '%20'),
