...
package dk.dbc.rawrepo.notify.deploy
...
class NotifyDeployScript extends GluScriptBase {
     ...
     *
     * artifact            : String  : An URL pointing to the notify-service distribution
     *                                 (REQUIRED).
     *
     * contextPath         : String  : The context path to deploy to
     *                                 (OPTIONAL). Defaults to '/rawreponotify'.
     *
     ...
     *                                 (REQUIRED).
     *
     * threadPoolSize      : String  : Number of threads that perform notifications
     *                                 (REQUIRED).
     *
    ...
    static String JDBC_RESOURCE = "jdbc/rawreponotify/rawrepo"
    static String JDBC_POOL = "jdbc/rawreponotify/rawrepo/pool"
    ...
    def install = {
        ...
        ["dbUrl", "dbUser", "dbPassword", "dbQueueWorker", "pollInterval", "threadPoolSize" ].each({
            if (!params."$it") {
    ...
    def configure = {
        ...
        contextPath = params.contextPath ?: "/rawreponotify"
...
<configuration>
  ...
  <appender name="indexerlog" class="ch.qos.logback.core.rolling.RollingFileAppender">
    <file>${logFolder.file.getPath()}/notify.log</file>
    <triggeringPolicy class="ch.qos.logback.core.rolling.SizeBasedTriggeringPolicy">
      <maxFileSize>100MB</maxFileSize>
    </triggeringPolicy>
    <rollingPolicy class="ch.qos.logback.core.rolling.FixedWindowRollingPolicy">
      <fileNamePattern>${logFolder.file.getPath()}/notify.%i.log</fileNamePattern>
      <minIndex>1</minIndex>
  ...
  <appender name="notifyerror" class="ch.qos.logback.core.rolling.RollingFileAppender">
    <file>${logFolder.file.getPath()}/notify-error.log</file>
    <triggeringPolicy class="ch.qos.logback.core.rolling.SizeBasedTriggeringPolicy">
      <maxFileSize>100MB</maxFileSize>
    </triggeringPolicy>
    <rollingPolicy class="ch.qos.logback.core.rolling.FixedWindowRollingPolicy">
      <fileNamePattern>${logFolder.file.getPath()}/notify-error.%i.log</fileNamePattern>
      <minIndex>1</minIndex>
      <maxIndex>10</maxIndex>
    </rollingPolicy>
    <encoder class="ch.qos.logback.classic.encoder.PatternLayoutEncoder">
...
<configuration>
  ...
  <appender name="notifylog" class="ch.qos.logback.core.rolling.RollingFileAppender">
    <file>${logFolder.file.getPath()}/notify.log</file>
    <triggeringPolicy class="ch.qos.logback.core.rolling.SizeBasedTriggeringPolicy">
      <maxFileSize>100MB</maxFileSize>
    </triggeringPolicy>
