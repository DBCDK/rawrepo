...
public class RawRepoExceptionRecordNotFound extends RawRepoException {
    ...
    public RawRepoExceptionRecordNotFound() {
    }

    public RawRepoExceptionRecordNotFound(String message) {
        super(message);
    }

    public RawRepoExceptionRecordNotFound(String message, Throwable cause) {
        super(message, cause);
    }

    public RawRepoExceptionRecordNotFound(Throwable cause) {
        super(cause);
    }
