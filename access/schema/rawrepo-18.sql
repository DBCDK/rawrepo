...
CREATE        INDEX records_agencyid    ON records (agencyid); -- V13
...
CREATE TABLE relations ( -- V2
       ...
       CONSTRAINT relations_no_self_reference CHECK (agencyid <> refer_agencyid OR bibliographicrecordid <> refer_bibliographicrecordid)
);
