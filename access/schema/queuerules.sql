...
INSERT INTO queuerules (provider, worker, mimetype, changed, leaf) VALUES('opencataloging-update', 'fbs-sync', '', 'Y', 'A');
--
...
---
INSERT INTO queuerules (provider, worker, mimetype, changed, leaf) VALUES('bulk-fbs', 'fbs-sync', '', 'Y', 'A');
INSERT INTO queuerules (provider, worker, mimetype, changed, leaf) VALUES('bulk-broend', 'broend-sync', '', 'A', 'Y');
INSERT INTO queuerules (provider, worker, mimetype, changed, leaf) VALUES('bulk-solr', 'solr-sync', '', 'Y', 'A');
