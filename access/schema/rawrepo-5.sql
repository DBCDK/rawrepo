...
-- CREATE INDEX queue_idx_worker ON queue(worker, blocked); -- V4
-- CREATE INDEX queue_idx_queued ON queue(queued); -- V4
CREATE INDEX queue_idx_worker ON queue(worker, blocked, queued); --V4
