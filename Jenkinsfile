            ...
            steps {
                script {
                    withMaven( maven: 'maven 3.5', options: [
                        ...
                        sh "mvn clean"
                        sh "mvn verify pmd:pmd findbugs:findbugs javadoc:aggregate -Dmaven.test.failure.ignore=false  -pl '!debian,!docker,!docker/introspect,!docker/content-service,!docker/maintain,!docker/postgres'"
                    }
                }
            }
            post {
